...
class RecipeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.FindRecipes = channel.unary_unary(
                '/recipe.RecipeService/FindRecipes',
...
class RecipeServiceServicer(object):
    ...
    def FindRecipes(self, request, context):
...
def add_RecipeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FindRecipes': grpc.unary_unary_rpc_method_handler(
                    servicer.FindRecipes,
...
class RecipeService(object):
    ...
    def FindRecipes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/recipe.RecipeService/FindRecipes',
